...
for start_p, end_p in comb_all:
  ...
  rc2 = map_interface.GetRoadCorridor(road_ids, XodrDrivingDirection.forward)
  ...
  viewer.drawWorld(world)
  viewer.drawRoadCorridor(rc2, "red")
  viewer.saveFig(output_dir + "/" + "roadcorridor_" + str(cnt) + "_with_driving_direction.png")
  viewer.show()
  viewer.clear()

  # for idx, lane_corridor in enumerate(rc2.lane_corridors):
  #   viewer.drawWorld(world)
