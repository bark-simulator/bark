...
class CppParamServerTestObject {
  public:
    CppParamServerTestObject(std::shared_ptr<bark::commons::Params> params) : params_(params) {
    ...
    bark::commons::ListListFloat GetListListFloatValue() const { return value_list_list_float_;} 
    bark::commons::ListFloat GetListFloatValue() const { return value_list_float_;} 
