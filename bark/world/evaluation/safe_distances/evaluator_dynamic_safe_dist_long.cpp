...
EvaluatorDynamicSafeDistLong::EvaluatorDynamicSafeDistLong(const bark::commons::ParamsPtr& params, const AgentId& agent_id) :
    ...
    safe_dist_label_function("safe_dist_longitudinal", 
        ...
        params->GetReal("EvaluatorDynamicSafeDistLong::ReactionTimeEgo", "Reaction time ego", 0.2f),
        params->GetReal("EvaluatorDynamicSafeDistLong::ReactionTimeOthers", "Reaction time others", 0.8f),
