...
void python_geometry(py::module m) {
  ...
  m.def("Within", py::overload_cast<const Point2d &, const Polygon&>(
    &Within),
    "Returns true if point within polygon");

  m.def("Within", py::overload_cast<const Line &, const Polygon &>(
    &Within),
    "Returns true if line within polygon");

  m.def("Within", py::overload_cast<const Polygon &, const Polygon &>(
    &Within),
  ...
  py::enum_<bark::geometry::Model3D::Type>(m,
    "bark::geometry::Model3DType", py::arithmetic())
