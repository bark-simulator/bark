...
void python_geometry(py::module m) {
  ...
  py::class_<Line, std::shared_ptr<Line>>(m, "Line2d")
      ...
      .def("AffineTransform", &Line::AffineTransform, "scales object around center point then translates and rotates it.")
  ...
  py::class_<Polygon, std::shared_ptr<Polygon>>(m, "Polygon2d")
      ...
      .def("AffineTransform", &Polygon::AffineTransform, "scales object around center point and then translate it.")
