...
#include "bark/world/evaluation/evaluator_being_overtaken.hpp"
...
#include "bark/world/evaluation/evaluator_safe_distance.hpp"
#include "bark/world/evaluation/evaluator_safe_lane_change.hpp"
#include "bark/world/evaluation/evaluator_speed_advantage_overtake.hpp"
#include "bark/world/evaluation/evaluator_step_count.hpp"
#include "bark/world/evaluation/evaluator_zip_merge_chn.hpp"
#include "bark/world/evaluation/evaluator_zip_merge_deu.hpp"
#include "bark/world/evaluation/labels/agent_at_lane_end_label_function.hpp"
#include "bark/world/evaluation/labels/agent_beyond_point_label_function.hpp"
...
#include "bark/world/evaluation/labels/ego_accelerate_label_function.hpp"
#include "bark/world/evaluation/labels/ego_beyond_point_label_function.hpp"
#include "bark/world/evaluation/labels/front_of_label_function.hpp"
#include "bark/world/evaluation/labels/generic_ego_label_function.hpp"
...
#include "bark/world/evaluation/labels/preceding_agent_label_function.hpp"
#include "bark/world/evaluation/labels/rel_speed_label_function.hpp"
#include "bark/world/evaluation/labels/right_of_label_function.hpp"
#include "bark/world/evaluation/labels/safe_distance_label_function.hpp"
#include "bark/world/tests/constant_label_evaluator.hpp"
...
void python_evaluation(py::module m) {
  ...
  py::class_<EvaluatorLTL, BaseEvaluator, std::shared_ptr<EvaluatorLTL>>(
      ...
      .def("__repr__", [](const EvaluatorLTL &g) {
        return "bark.core.world.evaluation.EvaluatorLTL";
      });
  ...
  py::class_<EvaluatorRightOvertake, BaseEvaluator,
      ...
      .def("__repr__", [](const EvaluatorRightOvertake &g) {
        return "bark.core.world.evaluation.EvaluatorRightOvertake";
      });
  ...
  py::class_<EvaluatorSafeDistance, BaseEvaluator,
      ...
      .def("__repr__", [](const EvaluatorSafeDistance &g) {
        return "bark.core.world.evaluation.EvaluatorSafeDistance";
      });
  ...
  py::class_<EvaluatorSafeLaneChange, BaseEvaluator,
      ...
      .def("__repr__", [](const EvaluatorSafeLaneChange &g) {
        return "bark.core.world.evaluation.EvaluatorSafeLaneChange";
      });
  ...
  py::class_<EvaluatorSafeLaneChangeAssumption, BaseEvaluator,
      ...
      .def("__repr__", [](const EvaluatorSafeLaneChangeAssumption &g) {
        return "bark.core.world.evaluation.EvaluatorSafeLaneChangeAssumption";
      });
  ...
  py::class_<EvaluatorBeingOvertaken, BaseEvaluator,
      ...
      .def("__repr__", [](const EvaluatorBeingOvertaken &g) {
        return "bark.core.world.evaluation.EvaluatorBeingOvertaken";
      });
  ...
  py::class_<EvaluatorBeingOvertakenAssumption, BaseEvaluator,
      ...
      .def("__repr__", [](const EvaluatorBeingOvertakenAssumption &g) {
        return "bark.core.world.evaluation.EvaluatorBeingOvertakenAssumption";
      });
  ...
  py::class_<EvaluatorSpeedAdvantageOvertake, BaseEvaluator,
      ...
      .def("__repr__", [](const EvaluatorSpeedAdvantageOvertake &g) {
        return "bark.core.world.evaluation.EvaluatorSpeedAdvantageOvertake";
      });
  ...
  py::class_<EvaluatorZipMergeDeu, BaseEvaluator,
      ...
      .def("__repr__", [](const EvaluatorZipMergeDeu &g) {
        return "bark.core.world.evaluation.EvaluatorZipMergeDeu";
      });
  ...
  py::class_<EvaluatorZipMergeChn, BaseEvaluator,
      ...
      .def("__repr__", [](const EvaluatorZipMergeChn &g) {
        return "bark.core.world.evaluation.EvaluatorZipMergeChn";
      });
  ...
  py::class_<EvaluatorRightOvertakeAssumption, BaseEvaluator,
      ...
      .def("__repr__", [](const EvaluatorRightOvertakeAssumption &g) {
        return "bark.core.world.evaluation.EvaluatorRightOvertakeAssumption";
      });
