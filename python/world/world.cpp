...
void python_world(py::module m) {
  ...
  py::class_<ObservedWorld, World, std::shared_ptr<ObservedWorld>>(m, "ObservedWorld")
    ...
    .def("GetRoadCorridor", &ObservedWorld::GetRoadCorridor)
    .def("GetEgoAgent", &ObservedWorld::GetEgoAgent)
    .def("GetLaneCorridor", &ObservedWorld::GetLaneCorridor)
    .def("GetOtherAgents", &ObservedWorld::GetOtherAgents)
    .def("CurrentEgoState", &ObservedWorld::CurrentEgoState)
    .def("CurrentEgoPosition", &ObservedWorld::CurrentEgoPosition)
