...
#ifndef MODULES_WORLD_EVALUATION_LABELS_SAFE_DISTANCE_LABEL_EVALUATOR_HPP_
#define MODULES_WORLD_EVALUATION_LABELS_SAFE_DISTANCE_LABEL_EVALUATOR_HPP_
...
class SafeDistanceLabelEvaluator : public BaseLabelEvaluator {
 public:
  SafeDistanceLabelEvaluator(const std::string& label_str, bool to_rear,
...
#endif  // MODULES_WORLD_EVALUATION_LABELS_SAFE_DISTANCE_LABEL_EVALUATOR_HPP_
