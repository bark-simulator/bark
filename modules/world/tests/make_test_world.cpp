...
WorldPtr modules::world::tests::MakeTestWorldHighway() {
  ...
  AgentPtr agent2(new Agent(init_state2, beh_model1, dyn_model, exec_model,
                            car_polygon, params, goal_ptr, map_interface,
                            Model3D()));  // NOLINT
  agent2->SetAgentId(2);
  ...
  AgentPtr agent3(new Agent(init_state3, beh_model2, dyn_model, exec_model,
  ...
  AgentPtr agent4(new Agent(init_state4, beh_model3, dyn_model, exec_model,
                            polygon, params, goal_ptr, map_interface,
                            Model3D()));  // NOLINT
  agent4->SetAgentId(4);
