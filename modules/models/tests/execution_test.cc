...
TEST(execution_model, execution_model_interpolate) {
  ...
  Trajectory followed_trajectory1 = exec_model->Execute(0.5, test_trajectory, dyn_model);
  ...
  Trajectory followed_trajectory2 = exec_model->Execute(4, test_trajectory, dyn_model);
  ...
  Trajectory followed_trajectory3 = exec_model->Execute(0.9, test_trajectory, dyn_model);
